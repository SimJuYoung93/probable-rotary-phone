...
<%@page import="kr.or.ddit.utils.TemplateUtils"%>
...
<body>
<!-- 1. 클라이언트로부터 최소단과 최대단 2개의 파라미터를 입력받음. -->
<!-- 2. submit 이벤트 발생으로 gugudanservlet에게 파라미터 전송. -->
<form>
	<ul>
...
private boolean validate(String min,String max){
	boolean valid = true;
	if(StringUtils.isBlank(min)||StringUtils.isBlank(max)||!StringUtils.isNumeric(min)||!StringUtils.isNumeric(max)){
		valid=false;	
	}
	return valid;
}
